...
Original C++ source file: gen_mlir_passthrough_op_py.cc
"""
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MlirPassthroughOp", name,
        tld.op_callbacks, inputs, "mlir_module", mlir_module, "Toutputs",
        Toutputs)
      return _result
